...
const visionPrompt =
  "This is a place I'd like to go, please give a shortlist of 3 places this is likely to be. It may well be a known vacation destination. For each place give a wikipedia search link with the mostly likely name for that place. Format the links with <a href... tags";

const sendImgToOpenAI = async (base64Image) => {
  if (debug) {
...
module.exports = { sendImgToOpenAI };
